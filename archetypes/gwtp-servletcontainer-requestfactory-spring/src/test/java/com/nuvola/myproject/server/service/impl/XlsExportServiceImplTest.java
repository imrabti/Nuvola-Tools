...
import com.nuvola.myproject.server.service.XlsExportService;
import com.nuvola.myproject.shared.dto.TestXlsDTO;
...
@ContextConfiguration(locations = {"classpath*:META-INF/applicationContext.xml", "classpath*:/META-INF/applicationContext-security.xml"})
